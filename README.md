...
Click **Render Video** in the timeline to render using the current LFO timetable. Output contains *video only*; add audio later in your editor. Output is saved as `.webm` (backend renders may briefly create an `.ivf` intermediate).
